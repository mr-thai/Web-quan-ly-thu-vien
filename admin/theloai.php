<?php 
    ...
    require_once "../processing/xulytheloai.php";
?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <form class="form-inline" method="GET" action="theloai.php">
                                <div class="input-group w-100">
                                    <input type="text" name="keyword" class="form-control" placeholder="Tìm theo mã hoặc tên thể loại" value="<?php echo htmlspecialchars($keyword); ?>">
                                    <div class="input-group-append">
                                        <button class="btn btn-primary" type="submit">
                                            <i class="fas fa-search fa-sm"></i>
                                        </button>
                                        <a href="theloai.php" class="btn btn-light border">Đặt lại</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="card-body">
                            <?php
                                ...
                                if ($result && mysqli_num_rows($result) > 0) {
                                    while ($theloai = mysqli_fetch_assoc($result)) {
                                        $theloai_items[] = $theloai;
                                    }
                                }
                                $category_modals = array();
                            ?>

                            <?php if (!empty($theloai_items)): ?>
                                <div class="row">
                                    <?php foreach ($theloai_items as $theloai): ?>
                                        <div class="col-xl-4 col-md-6 mb-4">
                                            <div class="card border-left-primary h-100 py-2">
                                                <div class="card-body d-flex flex-column">
                                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                                        <h5 class="font-weight-bold text-primary mb-0"><?php echo htmlspecialchars($theloai['ten_the_loai']); ?></h5>
                                                        <span class="badge badge-light border">#<?php echo (int)$theloai['id_the_loai']; ?></span>
                                                    </div>

                                                    <p class="text-gray-600 small mb-3" style="min-height: 56px;">
                                                        <?php echo htmlspecialchars($theloai['mo_ta'] !== '' ? $theloai['mo_ta'] : 'Chưa có mô tả cho thể loại này.'); ?>
                                                    </p>

                                                    <div class="mt-auto d-flex justify-content-between">
                                                        <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editCategoryModal-<?php echo (int)$theloai['id_the_loai']; ?>">
                                                            <i class="fas fa-edit"></i> Sửa
                                                        </button>
                                                        <a href="theloai.php?delete_id=<?php echo (int)$theloai['id_the_loai']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Bạn có chắc muốn xóa thể loại này?');">
                                        ...
                                        <?php ob_start(); ?>
                                        <div class="modal fade" id="editCategoryModal-<?php echo (int)$theloai['id_the_loai']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    <form method="POST" action="theloai.php">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="hidden" name="id_the_loai" value="<?php echo (int)$theloai['id_the_loai']; ?>">
                                                            <div class="form-group">
                                                                <label>Tên thể loại</label>
                                                                <input type="text" name="ten_the_loai" class="form-control" required value="<?php echo htmlspecialchars($theloai['ten_the_loai']); ?>">
                                                            </div>
                                                            <div class="form-group mb-0">
                                                                <label>Mô tả</label>
                                                                <textarea name="mo_ta" class="form-control" rows="3"><?php echo htmlspecialchars($theloai['mo_ta']); ?></textarea>
                                                            </div>
                                                        </div>
                                        ...
                                        <?php $category_modals[] = ob_get_clean(); ?>
                                    <?php endforeach; ?>
                                </div>
                            ...
                            <?php else: ?>
                                <div class="text-center py-5">
                                    ...
                                    <p class="mb-1 text-gray-700">Không có thể loại nào.</p>
                                    <p class="mb-0 small text-gray-500">Nhấn "Thêm thể loại" để tạo mới.</p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
