                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <p>Thêm một số chất lượng, svg minh họa vào dự án của bạn nhờ vào <a
                                            target="_blank" rel="nofollow" href="https://undraw.co/">unDraw</a>, một
                                        bộ sưu tập hình ảnh svg đẹp được cập nhật liên tục mà bạn có thể sử dụng
                                        hoàn toàn miễn phí và không cần ghi công!</p>
                                    <a target="_blank" rel="nofollow" href="https://undraw.co/">Duyệt qua minh họa trên
                                        unDraw &rarr;</a>
                                </div>
                            </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p>SB Admin 2 sử dụng rộng rãi các lớp tiện ích Bootstrap 4 để giảm thiểu CSS bloat và hiệu suất trang kém. Các lớp CSS tùy chỉnh được sử dụng để tạo các thành phần tùy chỉnh và các lớp tiện ích tùy chỉnh.</p>
                                    <p class="mb-0">Trước khi làm việc với chủ đề này, bạn nên làm quen với khung Bootstrap, đặc biệt là các lớp tiện ích.</p>
                                </div>
                            </div>
